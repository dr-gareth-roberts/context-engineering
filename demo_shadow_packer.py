...
print("Scenario: Agent searches a codebase. Over the next 3 turns, it reads File 1, File 2, and File 3.")
print(f"Tokens: System ({SYSTEM_TOKENS}), File 1 ({FILE_1_TOKENS}), File 2 ({FILE_2_TOKENS}), File 3 ({FILE_3_TOKENS})\n")
...
print(f"Predictive: 0ms blocking the user (warmed in background)")
