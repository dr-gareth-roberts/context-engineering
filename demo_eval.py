import asyncio
from context_engineering import ContextItem, ScoringWeights
...
async def main():
    ...
    case1_items = [
        ...
        ContextItem(id="new_val", content="Price is $12", priority=9.0, supersedes="old_val"),
    ...
    case2_items = [
        ContextItem(id="parent", content="Global security policy summary.", priority=10.0),
        ContextItem(id="child1", content="Detail about passwords.", priority=5.0, parent_id="parent"),
        ContextItem(id="child2", content="Detail about firewalls.", priority=5.0, parent_id="parent"),
    ]
    tester.add_case(EvalCase(
    ...
    case3_items = [
        ContextItem(id="critical_1", content="Very long critical instruction. " * 10, priority=10.0), # approx 20 tokens
        ContextItem(id="critical_2", content="Another very long critical rule. " * 10, priority=10.0), # approx 20 tokens
    ]
    tester.add_case(EvalCase(
