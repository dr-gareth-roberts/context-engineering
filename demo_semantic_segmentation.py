...
from context_engineering import SemanticSegmenter, EmbeddingResult, EmbeddingProvider
...
class MockEmbeddingProvider(EmbeddingProvider):
    def embed(self, texts: List[str], model: str) -> EmbeddingResult:
        ...
        for text in texts:
            ...
            if any(word in text.lower() for word in ["machine", "learning", "neural", "data", "ai"]):
