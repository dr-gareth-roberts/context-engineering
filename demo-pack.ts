...
const items = [
  ...
  },
  {
    ...
    content:
      "The user is working on a Context Engineering Toolkit that helps managed token budgets for LLMs.",
    priority: 8,
  },
  {
    id: "huge-log-file",
    content:
      "DEBUG: 10:00:01 - System started. 10:00:02 - Initializing modules. 10:00:03 - Warning: Memory high. 10:00:04 - Error: Connection lost. 10:00:05 - Retrying...",
    priority: 3,
    compressions: [
      {
        content:
          "Log summary: System started with a connection error at 10:00:04.",
        note: "summarized",
      },
    ],
  },
