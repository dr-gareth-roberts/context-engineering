...
async def main():
    ...
    items = [
        ContextItem(
            id="db_endpoint_v1", content="DATABASE_URL=postgres://old-cluster:5432", priority=8.0
        ),
        ContextItem(
            id="db_endpoint_v2",
        ...
        ContextItem(id="general_info", content="User is a senior developer.", priority=5.0),
    ]
