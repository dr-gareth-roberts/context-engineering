...
@dataclass(slots=True)
class HTTPClauseRiskAdapter(_HTTPJSONAdapterBase):
...
@dataclass(slots=True)
class HTTPNegotiationPrecedentAdapter(_HTTPJSONAdapterBase):
...
@dataclass(slots=True)
class HTTPContractActionAdapter(_HTTPJSONAdapterBase):
...
@dataclass(slots=True)
class ContractNegotiationCommander:
    ...
    def _execute_tasks(self, tasks: list[_ExecutionTask]) -> list[ContractActionResult]:
        if not tasks:
            return []
    ...
    def _execute_task(self, task: _ExecutionTask) -> ContractActionResult:
