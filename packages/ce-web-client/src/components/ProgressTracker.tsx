...
export function ProgressTracker() {
  ...
  const groupedSections = workshopSections.reduce(
    (acc, section) => {
      ...
      <div className="whiteboard-card p-8 mb-8">
        ...
        <div className="mb-8 p-6 bg-blue-50 border-2 border-[#0066CC] rounded-lg">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-2xl font-display marker-blue">
          ...
          <div className="mt-3 text-sm text-gray-600">
            {progress.completedSections.length} of {workshopSections.length}{" "}
            sections completed
          </div>
        </div>
        ...
        {bestScore && (
          <div className="mb-8 p-6 bg-green-50 border-2 border-[#27AE60] rounded-lg">
            ...
            <div className="text-3xl font-display marker-green">
              ...
              {bestScore.percentage.toFixed(0)}%)
            </div>
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-display marker-black">
            Section Checklist
          </h3>
                ...
                {sections.map(section => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`${isComplete ? "font-semibold text-gray-900" : "text-gray-700"}`}
                      >
                        {section.title}
                      </span>
                    </div>
        ...
        {completionPercentage === 100 && (
          <div className="mt-8 p-6 bg-yellow-50 border-l-4 border-[#F39C12] rounded">
            ...
            <p className="text-sm text-gray-700">
              Congratulations! You've completed the Context Engineering
              Workshop. Continue practising these techniques in your own
              projects and stay engaged with the community to keep learning.
            </p>
          </div>
        )}
      </div>
