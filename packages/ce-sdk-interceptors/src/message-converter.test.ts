...
describe("contextItemsToMessages", () => {
  it("preserves original message objects in order", () => {
    ...
    const keptItems = [
      { id: "msg-0", content: "sys", metadata: { originalIndex: 0, role: "system" } },
      { id: "msg-2", content: "hi", metadata: { originalIndex: 2, role: "assistant" } },
    ];
  ...
  it("injects a summary message when provided", () => {
    ...
    const keptItems = [
      { id: "msg-0", content: "sys", metadata: { originalIndex: 0, role: "system" } },
      { id: "msg-1", content: "recent", metadata: { originalIndex: 1, role: "user" } },
    ];
  ...
  it("does not inject summary when not provided", () => {
    ...
    const keptItems = [
      { id: "msg-0", content: "hello", metadata: { originalIndex: 0, role: "user" } },
    ];
