...
async def main():
    ...
    items = [
        ...
        ContextItem(id="p4_long", content="Background documentation. " * 20, priority=4.0), # ~60 tokens
        ContextItem(id="p5_low", content="Optional low-priority tip. " * 10, priority=2.0), # ~30 tokens
    ]
