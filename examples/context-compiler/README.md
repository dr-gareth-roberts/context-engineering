...
2. **Multi-model compilation:** The same items compiled for Claude (primacy/recency attention bias) and GPT-4 (uniform attention with logical grouping), showing how item ordering differs.
